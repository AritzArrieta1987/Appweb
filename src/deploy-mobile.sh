...
echo "📱 DESPLEGANDO BIGARTIST CON BOTTOM NAVIGATION MÓVIL"
echo "=================================================="
echo ""
...
echo "1️⃣ Actualizando DashboardSimple.tsx con Bottom Navigation..."

# Crear backup
cp /var/www/bigartist/repo/src/components/DashboardSimple.tsx /var/www/bigartist/repo/src/components/DashboardSimple.tsx.backup

# Actualizar archivo
cat > /var/www/bigartist/repo/src/components/DashboardSimple.tsx << 'EOF'
...
export default function DashboardSimple({ onLogout }: DashboardProps) {
  ...
  return (
    <div style={{
      minHeight: '100vh',
      background: 'linear-gradient(180deg, #2a3f3f 0%, #1e2f2f 100%)',
      color: '#ffffff',
...
if [ $? -eq 0 ]; then
  ...
  echo ""
  echo "3️⃣ Desplegando al servidor..."
  ...
  echo ""
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  echo "✅ ¡DASHBOARD MÓVIL DESPLEGADO CON ÉXITO!"
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  echo ""
  echo "🌐 URL: https://app.bigartist.es"
  echo ""
  echo "📱 CARACTERÍSTICAS MÓVILES:"
  echo "   ✅ Bottom Navigation (≤768px)"
  echo "   ✅ 6 tabs con iconos grandes"
  echo "   ✅ Glassmorphism + blur background"
  echo "   ✅ Safe area para iPhone"
  echo "   ✅ Transiciones suaves"
  echo "   ✅ Tab activo con efecto dorado"
  echo ""
  echo "💻 CARACTERÍSTICAS DESKTOP:"
  echo "   ✅ Tabs horizontales arriba"
  echo "   ✅ Botón Salir visible"
  echo "   ✅ Layout completo"
  echo ""
  echo "🧪 PRUEBA EN MÓVIL:"
  echo "   1. Abre https://app.bigartist.es en el móvil"
  echo "   2. Verás el bottom nav abajo"
  echo "   3. Toca cada icono para cambiar de sección"
  echo ""
  echo "🔄 Limpia caché: Cmd+Shift+R (Mac) o Ctrl+Shift+R (Windows)"
  echo ""
else
  echo ""
